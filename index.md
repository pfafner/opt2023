 ...
 **No.**  | **Fecha**    | **Tópicos**                                                               | **Recursos**
 -------- | ------------ | ------------------------------------------------------------------------- |  ---------------------------------
  ...
  11      | 01.08.2023   | Matrices positivas definidas. Matrix positiva más cercana. Aplicación de la descomposición de CHolesky.  [cholesky.ipynb](code/cholesky.ipynb){:target="_blank"} [generate_gaussian.ipynb](code/generate_gaussian.ipynb){:target="_blank"} | Ver Aula05. <br/> Burden-Faires, Cap. 6. 
