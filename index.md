 ...
 **No.**  | **Fecha**    | **Tópicos**                                                               | **Recursos**
 -------- | ------------ | ------------------------------------------------------------------------- |  ---------------------------------
  ...
  02      | 06.07.2023   | Ejemplo de norma 2. Conceptos: kernel, nulidad, rango. [Aula 02](aulas/Aula02.pdf){:target="_blank"} | Tref. Lecture 3.  
  03      | 11.07.2023   | Descomposición espectral. <br/>. [Aula 03](aulas/Aula03.pdf){:target="_blank"} | Tref., Lecture 4.
  04      | 13.07.2023   | Descomposición en valores singulares (SVD). <br/>. [Aula 04](aulas/Aula04.pdf){:target="_blank"} | Tref., Lecture 5.
