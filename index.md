 ...
 **No.**  | **Fecha**    | **Tópicos**                                                               | **Recursos**
 -------- | ------------ | ------------------------------------------------------------------------- |  ---------------------------------
  01      | 04.07.2023   | Introducción al curso. Normas matriciales. <br/> [Aula 01](aulas/Aula01.pdf){:target="_blank"} | Trefethen, Lecture 3.
  02      | 06.07.2023   | Ejemplo de norma 2. Conceptos: kernel, rango, error. <br/> [Aula 02](aulas/Aula02.pdf){:target="_blank"} | Trefethen, Lecture 3, <br/> Fukunaga, Appendix.  
